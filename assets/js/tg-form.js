document.querySelector("form.pure-form")
    .addEventListener("submit", function (e) {
        ...
        if (nameInput === "") {
            ...
            var send_message =
                "Hey Dhanashree, you have a contact detail from a new client!!!%0A%0A" +
                "<b>Name:</b> " +
                nameInput +
                "%0A<b>Email:</b> " +
                emailInput +
            ...
            var bot_token = "5413407604:AAG8juNz4DGowBoHGwQpXcuVTO0xoJS06Rs"; // bot token
            var chat_id = 1298884761; // my chat id
